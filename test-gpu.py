...
data_dir = '/home/corleone/pds/resnet-torch/sample/val/'#
...
#model=torch.load('/home/corleone/resnet-torch/kill-the-bits/resnet50-sample.pth')
model.eval()
...
for ii in range(len(images)):
    ...
    if (res==True):
        success+=1
plt.text(300,300,"accuracy :" + str(success*2) + "%")
plt.show()
